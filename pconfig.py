...
# IMAGE1 = os.path.join(IMG_PATH, "img_0050.jpg")
# IMAGE2 = os.path.join(IMG_PATH, "img_0050.jpg")
# IMAGE3 = os.path.join(IMG_PATH, "img_0051.jpg")
# IMAGE4 = os.path.join(IMG_PATH, "img_0052.jpg")
# IMAGE5 = os.path.join(IMG_PATH, "img_0053.jpg")
# IMAGE6 = os.path.join(IMG_PATH, "img_0054.jpg")
# IMAGE7 = os.path.join(IMG_PATH, "img_0055.jpg")
# IMAGE8 = os.path.join(IMG_PATH, "img_0060.jpg")
